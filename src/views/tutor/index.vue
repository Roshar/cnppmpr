                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-column align-items-center text-center">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <button class="btn btn-outline-primary" @click="goToModule('editProfile')">Редактировать профиль</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container-st">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="feature-box-1" @click="goToModule('students')">
                                <div class="icon">
                        ...
                        <!-- feaure box -->
                        <div class="col-sm-6 col-lg-3">
                            <div class="feature-box-1" @click="goToModule('iom')">
                                <div class="icon">
